...
AptechkaDefaultConfig.VanceSkin = function(self)
	...
	local font = [[Interface\AddOns\Aptechka_Vance\media\SFPixelate.ttf]]
	local fontsize = 10
    ...
    pb:SetStatusBarTexture([[Interface\AddOns\Aptechka_Vance\media\statusbar]])
    ...
    pbbg:SetTexture([[Interface\AddOns\Aptechka_Vance\media\statusbar]])
    ...
    hp:SetStatusBarTexture([[Interface\AddOns\Aptechka_Vance\media\statusbar]])
    ...
    hpbg:SetTexture([[Interface\AddOns\Aptechka_Vance\media\statusbar]])
...
AptechkaDefaultConfig.VanceSkinSettings = function()
