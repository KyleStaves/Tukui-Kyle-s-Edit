...
L["Select when to show rating conversions in tooltips. Modifier keys needs to be pressed before showing the tooltips."] = "툴팁에 능력치 변환을 표시할 것인지 선택합니다. 툴팁에 표시하려면 기능키를 눌러야 합니다."
-- /rb rating spell
...
L["Select when to show base stat conversions in tooltips. Modifier keys needs to be pressed before showing the tooltips."] = "툴팁에 기본 스탯을 표시하려면 선택합니다. 툴팁에 표시하기 위해서는 기능키를 눌러야 합니다."
---------------------------------------------------------------------------
-- /rb stat str
L["Strength"] = "힘"
...
L["Show Parry Rating"] = "무기 막기 숙련도"
L["Show Parry Rating from Strength"] = "힘에 의한 무기 막기 숙련도를 표시합니다."
-- /rb stat str parry
L["Show Parry"] = "무기 막기"
...
-- /rb stat agi dmg
L["Show Spell Damage"] = "주문 공격력 표시"
L["Show Spell Damage from Agility"] = "민첩성에 의한 주문 공격력을 표시합니다."
-- /rb stat agi heal
L["Show Healing"] = "치유량 표시"
...
-- /rb stat int mp5
L["Show Combat Mana Regen"] = "전투시 마나 회복 표시"
L["Show Mana Regen while in combat from Intellect"] = "지능에 의한 전투중 마나 회복량을 표시합니다."
-- /rb stat int mp5oc
L["Show Normal Mana Regen"] = "비 전투시 마나 회복 표시"
L["Show Mana Regen while not in combat from Intellect"] = "지능에 의한 비전투시 마나 회복량을 표시합니다."
-- /rb stat int rap
L["Show Ranged Attack Power"] = "원거리 전투력 표시"
...
-- /rb stat spi mp5
L["Show Combat Mana Regen"] = "전투시 마나 회복 표시"
L["Show Mana Regen while in combat from Spirit"] = "정신력에 의한 전투시 마나 회복량을 표시합니다."
-- /rb stat spi mp5oc
L["Show Normal Mana Regen"] = "비전투시 마나 회복 표시"
L["Show Mana Regen while not in combat from Spirit"] = "정신력에 의한 비전투시 마나 회복량을 표시합니다."
-- /rb stat spi hp5
L["Show Normal Health Regen"] = "비전투시 생명력 회복 표시"
L["Show Health Regen while not in combat from Spirit"] = "정신력에 의한 비전투시 생명력 회복량을 표시합니다."
-- /rb stat spi dmg
L["Show Spell Damage"] = "주문 공격력 표시"
...
L["Show Spell Hit Rating"] = "주문 공격 적중도 표시"
L["Show Spell Hit Rating from Spirit"] = "정신력에 의한 주문 적중 공격도를 표시합니다."
-- /rb stat spi spellhit
L["Show Spell Hit"] = "주문 공격 적중 표시"
L["Show Spell Hit from Spirit"] = "정신력에 의한 주문 공격 적중을 표시합니다."
---------------------------------------------------------------------------
-- /rb stat armor
L["Armor"] = "방어도"
...
L["Select when to show stat summary in tooltips. Modifier keys needs to be pressed before showing the tooltips."] = "툴팁에 스탯 요약치를 표시하려면 선택합니다. 툴팁에 표시하려면 기능키를 눌러야 합니다."
-- /rb sum ignore
...
-- /rb sum basic mp5
L["Sum Combat Mana Regen"] = "전투시 마나 회복 합계"
L["Combat Mana Regen <- Mana Regen, Spirit"] = "전투시 마나 회복 <- 마나 회복, 정신력"
-- /rb sum basic mp5oc
L["Sum Normal Mana Regen"] = "비전투시 마나 회복 합계"
L["Normal Mana Regen <- Spirit"] = "비전투시 마나 회복 <- 정신력"
-- /rb sum basic hp5
L["Sum Combat Health Regen"] = "전투시 생명력 회복 합계"
L["Combat Health Regen <- Health Regen"] = "전투시 생명력 회복 <- 생명력 회복"
-- /rb sum basic hp5oc
L["Sum Normal Health Regen"] = "비전투시 생명력 회복 합계"
L["Normal Health Regen <- Spirit"] = "비전투시 생명력 회복 <- 정신력"
-- /rb sum basic str
L["Sum Strength"] = "힘 합계"
...
L["Sum Mastery"] = "특화력 합계"
L["Mastery Summary"] = "특화력 요약"
-- /rb sum basic masteryrating
L["Sum Mastery Rating"] = "특화도 합계"
L["Mastery Rating Summary"] = "특화도 요약"
---------------------------------------------------------------------------
-- /rb sum physical
...
L["Crit Chance <- Crit Rating, Agility"] = "치명타율 <- 치명타 적중도, 민첩성"
...
L["Ranged Hit Chance <- Hit Rating, Ranged Hit Rating"] = "원거리 적중률 <- 적중도, 원거리 적중도"
...
L["Ranged Crit Chance <- Crit Rating, Agility, Ranged Crit Rating"] = "원거리 치명타율 <- 치명타 적중도, 민첩성, 치명타 적중도"
...
-- /rb sum spell power
L["Sum Spell Power"] = "주문력 합계"
L["Spell Power <- Spell Power, Intellect, Agility, Strength"] = "주문력 <- 주문력, 지능, 민첩, 힘"
-- /rb sum spell dmg
...
-- /rb sum tank armor
L["Sum Armor"] = "방어도 합계"
L["Armor <- Armor from items and bonuses"] = "방어도 <- 아이템 방어도, 방어도 보너스"
-- /rb sum tank dodge
L["Sum Dodge Chance"] = "회피율 합계"
L["Dodge Chance <- Dodge Rating, Agility"] = "회피율 <- 회피 숙련도, 민첩성"
-- /rb sum tank parry
L["Sum Parry Chance"] = "무기 막기 확률 합계"
L["Parry Chance <- Parry Rating"] = "무기 막기 확률 <- 무기 막기 숙련도"
-- /rb sum tank block
L["Sum Block Chance"] = "방패 막기 확률 합계"
L["Block Chance <- Block Rating"] = "방패 막기 확률 <- 방패 막기 숙련도"
-- /rb sum tank neglectdodge
L["Sum Dodge Neglect"] = "회피 무시 합계"
L["Dodge Neglect <- Expertise"] = "회피 무시 <- 숙련도"
-- /rb sum tank neglectparry
L["Sum Parry Neglect"] = "무기 막기 무시 합계"
L["Parry Neglect <- Expertise"] = "무기 막기 무시 <- 숙련도"
...
L["Total Reduction <- Armor, Dodge, Parry, Block, MobMiss, MobCrit, MobCrush, DamageTakenMods"] = "총 피해감소 <- 방어도, 회피, 무기 막기, 방패 막기, 빗맞힘(자신), 치명타 감소, 몹강타, 피해감소 효과"
-- /rb sum tank avoid
