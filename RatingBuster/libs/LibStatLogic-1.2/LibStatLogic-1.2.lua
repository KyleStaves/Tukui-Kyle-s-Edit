...
Last Update: $Date: 2010-12-14 13:22:36 +0000 (Tue, 14 Dec 2010) $
Website:
Documentation:
SVN: $URL $
Dependencies: UTF8
...
elseif playerClass == "WARRIOR" then
  ...
  StatModTable["ALL"] = {
	...
	--[[
		...
		It could be implemented as a GetHealthPerStamina(level) function (which i started to d0), but everyone would have to change their code
		to stop using the hard-coded "10 health per stamina"
		Instead we can code it as a set of conditional percentage modifiers
		...
		Question: Could the mod be written as the following:
				{
