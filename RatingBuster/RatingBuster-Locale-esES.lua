...
--L["Select when to show rating conversions in tooltips. Modifier keys needs to be pressed before showing the tooltips."] = "Mostrar conversion de indices en tooltips"
-- /rb rating spell
...
--L["Select when to show base stat conversions in tooltips. Modifier keys needs to be pressed before showing the tooltips."] = "Muestra las conversiones de estad. base en los tooltip"
-----------------------------------------------------------------------------------------
-- /rb stat str
L["Strength"] = "Fuerza"
...
-- /rb stat int mp5
--L["Show Combat Mana Regen"] = "Mostrar Regen.Mana"
--L["Show Mana Regen while in combat from Intellect"] = "Muestra la Regen.Mana de Intelecto"
-- /rb stat int mp5oc
...
-- /rb stat spi mp5
--L["Show Combat Mana Regen"] = "Mostrar Regen.Mana"
--L["Show Mana Regen while in combat from Spirit"] = "Muestra la Regen.Mana de Espiritu"
-- /rb stat spi mp5oc
--L["Show Normal Mana Regen"] = "Mostrar Regen.Mana NO lanzando"
--L["Show Mana Regen while not in combat from Spirit"] = "Muestra la Regen.Mana NO lanzando de Espiritu"
-- /rb stat spi hp5
--L["Show Normal Health Regen"] = "Mostrar Regen.Salud"
--L["Show Health Regen while not in combat from Spirit"] = "Muestra la Regen. de Salud de Espiritu"
-- /rb stat spi dmg
L["Show Spell Damage"] = "Mostrar Dano Hech"
...
--L["Select when to show stat summary in tooltips. Modifier keys needs to be pressed before showing the tooltips."] = "Muestra el Resumen de Estad. en los tooltips"
-- /rb sum ignore
...
-- /rb sum basic mp5
--L["Sum Combat Mana Regen"] = "Suma Mana regenerado"
--L["Combat Mana Regen <- Mana Regen, Spirit"] = "Suma Mana reg <- Mana Regen, Espiritu"
-- /rb sum basic mp5oc
--L["Sum Normal Mana Regen"] = "Res. Regen. mana mientras no se lanza"
--L["Normal Mana Regen <- Spirit"] = "Regen. mana mientras no se lanza <- Espiritu"
-- /rb sum basic hp5
--L["Sum Combat Health Regen"] = "Res. Regen. salud"
--L["Combat Health Regen <- Health Regen"] = "Regen. salud <- Regen. salud"
-- /rb sum basic hp5oc
--L["Sum Normal Health Regen"] = "Res. Regen. salud fuera de combate"
--L["Normal Health Regen <- Spirit"] = "Regen. salud fuera de combate <- Espiritu"
-- /rb sum basic str
...
L["statList"] = {
	...
	{pattern = "tu \195\173ndice de temple", id = COMBAT_RATING_RESILIENCE_PLAYER_DAMAGE_TAKEN}, -- resilience is implicitly a rating
