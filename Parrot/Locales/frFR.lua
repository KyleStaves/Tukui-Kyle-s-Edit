...
-- L["Abbrivate number values displayed (26000 -> 26k)"] = ""
...
L["Hide realm in player names (in battlegrounds)"] = "Cacher le royaume dans le nom des joueurs (Champs de bataille)"
