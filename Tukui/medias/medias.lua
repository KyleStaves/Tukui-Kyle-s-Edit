...
C["media"] = {
	...
	["bordercolor"] = C.general.bordercolor or { .3,.3,.3 }, -- border color of tukui panels
	["altbordercolor"] = C.unitframes.bordercolor or { .3,.3,.3 }, -- alternative border color, mainly for unitframes text panels.
