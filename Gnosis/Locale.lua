...
Gnosis.L["OptCBBWListedSpells"] = "Zauber auf der Black-/Whitelist"
...
Enter name of spell to black- or whitelist.

Multi-Spell Timer:
Basic format for every entry: cmds:spell

Auras (buffs&debuffs):
buff, debuff, dot, hot, aura, helpful, harmful, mine
...
Resources:
resource:health, power or altpower

Additional commands:
unit=UnitId (names possible)
nfs="override bar's name format string"
tfs="override bar's time format string"
lag, casttime, recast=dot tick time
staticdur=minimum time displayed by bar in seconds
nodur (allows displaying of static auras)
not (will show auras/cooldowns if not present/on cd)
sort where spell is minrem, maxrem, mindur, maxdur
sbcol="r,g,b,alpha" (override statusbar color)
spec=number of spec (1/2)

Examples:
sort:minrem
sort,spec=2:maxrem
cd,sbcol="1.0,0,0":Dispersion
resource,nfs="":health
cast,unit=boss1:all
cd,nfs="!!! name !!!":Dispersion
buff,mine,lag,unit=Helge:Renew
aura,mine,harmful,unit=target:Shadow Word: Pain
dot,mine,recast=3,staticdur=25:Vampiric Touch
buff,nodur,unit=boss1:Double Attack]=] -- Needs review
...
Gnosis.L["OptCBShowSpark"] = "Zeige Castspark" -- Needs review
Gnosis.L["OptCBSizeGrp"] = "Bar shape and visuals" -- Requires localization
Gnosis.L["OptCBSparkColor"] = "Farbe des Sparks" -- Needs review
Gnosis.L["OptCBSparkHeight"] = "Höhe des Sparks" -- Needs review
Gnosis.L["OptCBSparkWidth"] = "Breite des Sparks" -- Needs review
...
자원들:
resource:health, power 또는 altpower
...
dot,mine,recast=3,staticdur=25:흡혈의 손길]=]
...
Gnosis.L["Import"] = "Импорт" -- Needs review
...
Gnosis.L["OptCBAncToFrame"] = "Фиксировать к фрейму"
...
Gnosis.L["OptCBCombatSelAlways"] = "и в не боя"
...
Gnosis.L["OptCBInvBarDir"] = "Иверсия напровления палос"
...
aura,mine,harmful,unit=target:Shadow Word: Pain
dot,mine,recast=3,staticdur=25:Vampiric Touch
buff,nodur,unit=boss1:Double Attack]=] -- Requires localization
...
aura,mine,harmful,unit=target:Shadow Word: Pain
dot,mine,recast=3,staticdur=25:Vampiric Touch
buff,nodur,unit=boss1:Double Attack]=]
